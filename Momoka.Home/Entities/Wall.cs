...
/// <summary>
/// A wall segment: a straight line (see <see cref="Line3D"/>) with a
...
public class Wall : Entity<Int3>
{
    ...
    public static readonly IntProperty HEIGHT = new(FloorPlanLayout.HeightProperty, 3);
    public static readonly IntProperty THICKNESS = new(FloorPlanLayout.ThicknessProperty, 1);
