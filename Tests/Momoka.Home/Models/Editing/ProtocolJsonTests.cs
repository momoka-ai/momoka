...
public class ProtocolJsonTests
{
    ...
    public void FrameRegistry_AllTypesDiscriminate()
    {
        ...
        var events = new[] { "entity_created", "layout_changed", "region_changed", "save_completed", "snapshot", "error" };
    ...
    public void SnapshotEvent_RoundTrips_WithCatalog()
    {
        ...
        {
            ResidenceMeta = new ResidenceMeta { Name = "Home", Type = "condo" },
            Entities = new[] { entity },
        ...
        Assert.Equal("Home", parsed.ResidenceMeta.Name);
        Assert.Equal("condo", parsed.ResidenceMeta.Type);
    ...
    public void Topics_Map_Frames()
    {
        ...
        Assert.Equal(Topics.Regions, Topics.Of(new RegionChangedEvent()));
